package com.selling.system.data.sales.update.service;
...
public class QueryResponseServiceImpl implements QueryResponseService {
    ...
    public Mono<ResponseEntity<QueryResponse>> buildQueryResponse(QueryCommand queryCommand) {
        ...
        return QueryResponseMapperUtil.mapMonoToResponse(salesService.updateSale(toSale(queryCommand.getPayload())));
    }
}