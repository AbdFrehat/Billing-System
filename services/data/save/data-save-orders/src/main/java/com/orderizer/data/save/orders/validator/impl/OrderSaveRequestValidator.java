package com.orderizer.data.save.orders.validator.impl;

import com.orderizer.data.save.orders.exception.RequestBodyInvalidException;
import com.orderizer.data.save.orders.model.entity.Item;
import com.orderizer.data.save.orders.model.request.OrderRequest;
...
@Component
public class OrderSaveRequestValidator implements Validator<OrdersSaveRequest> {
    @Override
    ...
    private Mono<OrderRequest> validate(OrderRequest order) {
        return Mono.defer(() -> {
