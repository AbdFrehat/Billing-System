...
import com.selling.system.data.save.manager.sales.config.ServicesContextPathConfig;
...
public class SalesClientServiceImpl implements SalesClientService {
    ...
    private String getUri(CommandType commandType) {
        return switch (commandType) {
            case SAVE_SALE -> servicesContextPathConfig.getDataSaveMs();
            case SAVE_SALES -> servicesContextPathConfig.getDataSaveMultiMs();
