package com.orderizer.data.delete.orders.service;
...
public class QueryResponseServiceImpl implements QueryResponseService {
    ...
    public Mono<ResponseEntity<DataResponse>> buildQueryResponse(DataCommand dataCommand) {
        ...
        return QueryResponseMapperUtil.mapMonoToResponse(salesService.deleteSales(toSales(dataCommand.getPayload())));
    }
}