package com.selling.system.data.shared.module.service.interpreter.impl.operatprs;
...
public class OrExpression implements CriteriaExpression {

    private final CriteriaExpression criteriaExpression1;

    private final CriteriaExpression criteriaExpression2;

    public OrExpression(CriteriaExpression criteriaExpression1, CriteriaExpression criteriaExpression2) {
    ...
    public Criteria interpret(Map<String, QueryField> queryFields) {
        return new Criteria().orOperator(criteriaExpression1.interpret(queryFields), criteriaExpression2.interpret(queryFields));
    }
}
