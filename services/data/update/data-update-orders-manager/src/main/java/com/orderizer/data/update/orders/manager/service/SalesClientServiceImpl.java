package com.orderizer.data.update.orders.manager.service;

import com.orderizer.data.update.orders.manager.config.ServicesContextPathConfig;
...
public class SalesClientServiceImpl implements SalesClientService {
    ...
    private String getUri(CommandType commandType) {
        return switch (commandType) {
            case UPDATE_SALE -> servicesContextPathConfig.getDataUpdateMs();
            case UPDATE_SALES -> servicesContextPathConfig.getDataUpdateMultiMs();
