...
group = "com.orderizer.data.get.manager"
...
extra["springCloudContractStubRunnerVersion"] = "3.0.3"
...
dependencies {
    ...
    testImplementation("org.springframework.cloud:spring-cloud-starter-contract-stub-runner:${property("springCloudContractStubRunnerVersion")}")
