package com.orderizer.data.get.manager.controller;

import com.orderizer.data.get.manager.service.SalesClientService;
...
public class SalesRouterController {
     ...
     */
    @PostMapping
    public Mono<ResponseEntity<DataResponse>> routeDataServices(@RequestBody @Valid DataCommand dataCommand) {
