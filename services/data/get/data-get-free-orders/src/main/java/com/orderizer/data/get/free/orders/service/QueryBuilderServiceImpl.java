package com.orderizer.data.get.free.orders.service;
...
public class QueryBuilderServiceImpl implements QueryBuilderService {
    ...
    public Query buildQuery(DataCommand dataCommand) {
        var query = new Query();
        query.addCriteria(CriteriaBuilderUtil.buildTextCriteria(dataCommand.getQueryFields().get(FieldType.FREE.name())));
