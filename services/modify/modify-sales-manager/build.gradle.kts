...
group = "com.selling.system.modify.sales.manager"
...
extra["modifySharedModuleVersion"] = "1.0.0-SNAPSHOT"
...
dependencies {
	...
	implementation("com.selling.system.modify.shared.sales:modify-shared-sales:${property("modifySharedModuleVersion")}")
